...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-between">
      <ul class="navbar-nav">
        <a href="/">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Kahoot_Logo.svg/1200px-Kahoot_Logo.svg.png" alt="Logo Kahoot" width="100px" height="auto" style="filter: brightness(100);">
        </a>
      </ul>
      <ul class="navbar-nav">
